...
export class UserResolverBase {
  ...
  async condition(
    ...
    const results = await this.service.findCondition(parent.id, args);
  ...
  async doctor(
    ...
    const results = await this.service.findDoctor(parent.id, args);
  ...
  async doctorId(
    ...
    const results = await this.service.findDoctorId(parent.id, args);
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => [EmotionalState])
  @nestAccessControl.UseRoles({
  ...
  async emotionalState(
    ...
    const results = await this.service.findEmotionalState(parent.id, args);
